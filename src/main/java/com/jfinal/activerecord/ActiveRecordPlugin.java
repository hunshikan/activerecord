...
package com.jfinal.activerecord;

import com.jfinal.activerecord.cache.ICache;
import com.jfinal.activerecord.dialect.Dialect;
import com.jfinal.activerecord.sql.SqlKit;
...
public class ActiveRecordPlugin {
  ...
  public static void useAsDataTransfer(IContainerFactory containerFactory) {
    useAsDataTransfer(new com.jfinal.activerecord.dialect.MysqlDialect(), containerFactory, new com.jfinal.activerecord.cache.EhCache());
  }
  ...
  public static void useAsDataTransfer(Dialect dialect, IContainerFactory containerFactory) {
    useAsDataTransfer(dialect, containerFactory, new com.jfinal.activerecord.cache.EhCache());
  }
  ...
  public static void useAsDataTransfer(Dialect dialect) {
    useAsDataTransfer(dialect, IContainerFactory.defaultContainerFactory, new com.jfinal.activerecord.cache.EhCache());
  }
  ...
  public static void useAsDataTransfer() {
    useAsDataTransfer(new com.jfinal.activerecord.dialect.MysqlDialect(), IContainerFactory.defaultContainerFactory, new com.jfinal.activerecord.cache.EhCache());
  }
